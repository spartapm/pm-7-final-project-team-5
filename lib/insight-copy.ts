...
export const NARRATIVE1_SHOTS = [
  "차트에서 지지선 근처라고 판단했을 때, 가격이 떨어진 상태에서 매수하는 경향이 보여요",
  "차트나 거래량 변화를 보다가, 가격이 급하게 떨어질 때 매도하는 경향이 보여요",
  "커뮤니티나 지인 정보를 접했을 때, 다른 사람들과 비슷한 시점에 매수하는 패턴이 반복되고 있어요",
];
