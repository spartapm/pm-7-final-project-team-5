...
export const PRACTICE = {
  samsung: {
    ...
    reasons: ["시장 전체 분위기를 보고 · 시장 전체 지수가 크게 오르내려서", "차트를 보고 · 거래량이 갑자기 크게 늘거나 줄어서"],
    moods: ["많이 떨어져 있어서 지금이 기회라고 봤다", "확신은 없었지만 일단 들어가 봤다"],
  },
  kakao: {
    name: "카카오",
    code: "035720",
...
export const SAMPLE_INSIGHT = {
  ...
  policySub: "뚜렷한 경향이 안 보이면 이번엔 카드가 발행되지 않을 수 있어요",
};
